...
import { Activity, Shield, User, LogOut, Flame, Sparkles } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className={`w-10 h-10 rounded-2xl p-0.5 shadow-md flex items-center justify-center text-white font-extrabold ${
              ...
              {isAdminMode ? <Shield className="w-5 h-5" /> : <Flame className="w-5 h-5 fill-white" />}
            </div>
            <div>
              ...
              <p className="text-[11px] text-slate-400 hidden sm:block">
                {isAdminMode ? 'Executive Performance Reports & Team Overview' : 'Daily & Hourly Work Tracker'}
              </p>
            </div>
          </div>
