...
export const Navbar = ({
  ...
  const activeUser = isAdminMode ? adminUser : employeeUser;
      ...
      <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur-md shadow-xs">
        <div className="max-w-[1520px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            {/* Team Lead / Coordinator Navigation Tabs */}
            {!isAdminMode && isLead && employeeUser && (
              <div className="hidden sm:flex items-center gap-1 bg-slate-100 p-1 rounded-2xl border border-slate-200">
                ...
                >
                  ...
                  <span>{isCoordinator ? 'Team Progress (Coordinator)' : 'Team Progress (Team Lead)'}</span>
                </button>
                <button
              ...
              {!isAdminMode && employeeUser && (
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-2.5 sm:px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-amber-50 hover:text-amber-800 text-slate-700 text-xs font-bold border border-slate-200 transition-colors cursor-pointer"
              ...
              {isAdminMode && adminUser && (
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <button
                    type="button"
                    onClick={() => setIsPasswordModalOpen(true)}
                    className="flex items-center gap-1 px-2.5 sm:px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-indigo-50 hover:text-indigo-800 text-slate-700 text-xs font-bold border border-slate-200 transition-colors cursor-pointer"
